...
Import-Module PsCertutil

$here = Split-Path -Parent $MyInvocation.MyCommand.Path

$manifestPath   = "$here\PsCertutil.psd1"
...
Describe 'manifest and changelog' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be PsCertutil
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be '790a7dc2-50c8-42fe-9111-5cd68a74f9a2'
    }
...
Describe 'Style rules' {
    $moduleRoot = (Get-Module PsCertutil).ModuleBase
